...
if(isset($_POST['login']))
{
	...
	$query = mysqli_query($conn, "Select * FROM player1 WHERE username='".$uname."' AND password='".$password."'");
	/* database query */
	...
	$validate_query = mysqli_query($conn, "Select * FROM player1 WHERE username='".$uname."' AND active='0'");
